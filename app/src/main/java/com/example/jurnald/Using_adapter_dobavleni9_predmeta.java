...
public class Using_adapter_dobavleni9_predmeta implements Parcelable {
    ...
    public Using_adapter_dobavleni9_predmeta(Parcel in) {
        ...
        id_forma_control9=in.readInt();
    }

    @Override
    public void writeToParcel(Parcel out, int flags) {
        out.writeInt(this.id);
        out.writeInt(this.id_forma_control9);
    ...
    public static final Creator<Using_adapter_dobavleni9_predmeta> CREATOR = new Creator<Using_adapter_dobavleni9_predmeta>() {
        @Override
