...
public class Using_adapter_pokazat_3_pol9 implements Parcelable {
    String name_pervoe_pole,name_vtoroe_pole,name_tretie_pole;
    Integer id,id_vtoroe_pole,id_tretie_pole;

    public Using_adapter_pokazat_3_pol9(Integer id, String name_pervoe_pole,
                                             String name_vtoroe_pole,String name_tretie_pole,
                                        Integer id_vtoroe_pole, Integer id_tretie_pole) {
  ...
  //      spisok_predmeta.add(new Using_adapter_dobavleni9_predmeta(x.getId(), x.getName_group(), y.getName(), x.getId_napravlenie()));
    ...
    public Using_adapter_pokazat_3_pol9(Parcel in) {
        id = in.readInt();
    ...
    public static final Creator<Using_adapter_pokazat_3_pol9> CREATOR = new Creator<Using_adapter_pokazat_3_pol9>() {
        @Override
        public Using_adapter_pokazat_3_pol9 createFromParcel(Parcel source) {
            return new Using_adapter_pokazat_3_pol9(source);
        }

        @Override
        public Using_adapter_pokazat_3_pol9[] newArray(int size) {
            return new Using_adapter_pokazat_3_pol9[size];
        }
    };
}